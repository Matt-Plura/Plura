---
title: "Welcome to Plura"
description: "Your complete guide to building, deploying, and managing AI-powered voice agents"
---
...
<Note>
**No coding required** — With an intuitive interface and modular design, Plura enables teams to go from idea to live call with minimal effort.
</Note>
...
<CardGroup cols={2}>
  <Card title="Fast iteration" icon="bolt">
    Test and refine your flows in real time with our test bench and fine-tuning tools
  </Card>
  <Card title="AI transparency" icon="magnifying-glass">
    See exactly why the AI made a decision with full visibility into triggers, responses, and logic
  </Card>
  <Card title="No-code, pro-control" icon="palette">
    Design complex logic without touching code, while still accessing advanced configuration if needed
  </Card>
  <Card title="Scalable by default" icon="chart-line">
    Whether you're running one call or one million, Plura is built to handle production-level loads
  </Card>
</CardGroup>
...
Head to [app.plura.ai](https://app.plura.ai) and start building your first AI voice agent.

For support, contact us at [compliance@plura.ai](mailto:compliance@plura.ai)