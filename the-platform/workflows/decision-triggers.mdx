...
<Steps>
  <Step title="Define Decision Trigger">
    ...
    <img width="600" src="/images/define-decision-trigger.png" alt="Define Decision Trigger"/>
  ...
  <Step title="Define Decision Trigger Conditions">
    ...
    <img width="600" src="/images/define-decision-trigger-conditions.png" alt="Define Decision Trigger Conditions" />
